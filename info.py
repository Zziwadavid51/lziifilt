...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '5809671364').split()]
LAZY_RENAMERS = (lazy_renamers + ADMINS) if lazy_renamers else []
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '-1001624607501'))

#ai
GPTAI_API = environ.get("OPENAI_API","https://chatgpt.apinepdev.workers.dev")
...
DOWNLOAD_TEXT_URL = "https://t.me/mrrighteous99"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/blastwallztv"
